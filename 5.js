...
class Blender extends ElectricalAppliance {
    constructor(type, brand, name, power, rpm, capacityJar, materialJar, materialBody, features, state) {
        super(state);
        this.type = type;
        this.brand = brand;
        this.name = name;
...
class Fridge extends ElectricalAppliance {
    constructor (type, brand, name, power, size, style, capacity, material, features, state) {
        super(state);
        this.type = type;
        this.brand = brand;
        this.name = name;
